export default {
  route: {
    ...
    vulnerabilityBasic:'VulnerabilityBasic',
    warning_management:'WarningManagement',
    my_notification:'MyWarning',
    warning_process:'WarningProcess',
